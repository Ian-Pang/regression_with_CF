...
""" Takes two .hdf5 file as input and merges/shuffles them for classifier input
    ...
    This is step 2 in creating the dataset for the classifier test:
    1. split generated file in train/test/val set (split_classifier_hdf5.py)
    2. merge the generated sets with the corresponding GEANT4 sets (this file)
